...
export const UNIVERSITIES: University[] = [
  ...
  },
  {
    ...
    typicalAdmittedCGPA: 7.5,
    postStudyWorkVisaYears: 3,
    visaApprovalRateIndia: 0.74,
    tierTag: "solid",
    indianCohortNotes:
      "Friendlier admit bar than Melbourne or UNSW. The 485 Graduate visa is the real prize here, but watch the 2026 Australian visa tightening — refusal rates ticked up sharply this cycle.",
  },
  // ─── Australia · CS (1 more) ──────────────────────────────────────────
  {
    id: "anu-mcomp",
    ...
    country: "Australia",
    city: "Canberra",
    tuitionUSDPerYear: 33000,
    livingCostUSDPerYear: 22000,
    durationYears: 2,
    medianStartingSalaryUSD: 78000,
    employmentRate6Mo: 0.83,
    baselineAdmitRate: 0.4,
    typicalAdmittedGRE: 0,
    typicalAdmittedCGPA: 7.7,
    postStudyWorkVisaYears: 3,
    visaApprovalRateIndia: 0.76,
    tierTag: "solid",
    indianCohortNotes:
      "Canberra is small and government-heavy — fewer private tech jobs than Sydney or Melbourne, but lower cost of living balances it. ANU's research reputation carries the program.",
  },
  // ─── Business Analytics (2 more) ──────────────────────────────────────
  {
    id: "imperial-msba",
    university: "Imperial College London",
    programName: "MSc Business Analytics",
    ...
    typicalAdmittedCGPA: 8.3,
    postStudyWorkVisaYears: 2,
    visaApprovalRateIndia: 0.89,
    tierTag: "elite",
    indianCohortNotes:
      "Imperial's MSBA is the most quantitatively rigorous BA program in the UK. London placement is strong but you're competing for finance/consulting seats with LSE and LBS grads. GMAT 700+ helps but is not strictly required.",
  },
  {
    id: "nyu-stern-msba",
    ...
    typicalAdmittedCGPA: 8.4,
    postStudyWorkVisaYears: 3,
    visaApprovalRateIndia: 0.7,
    tierTag: "elite",
    indianCohortNotes:
      "STEM-designated, which means 3-year OPT — the same as a CS degree. The cohort is small and senior; expects 5+ years of work experience. Salary outcomes are the highest of any BA program globally.",
  },
  // ─── Management (3) ───────────────────────────────────────────────────
  {
    id: "lbs-mim",
    ...
    country: "UK",
    city: "London",
    tuitionUSDPerYear: 65000,
    livingCostUSDPerYear: 28000,
    durationYears: 1,
    medianStartingSalaryUSD: 85000,
    employmentRate6Mo: 0.93,
    baselineAdmitRate: 0.25,
    typicalAdmittedGRE: 320,
    typicalAdmittedCGPA: 8.2,
    ...
    tierTag: "elite",
    indianCohortNotes:
      "LBS MiM is the European MiM that places into bulge-bracket banking and tier-1 consulting from India. GMAT 690+ effectively required even though it's not on paper. Indian intake is small but growing.",
  },
  {
    id: "esmt-mim",
    university: "ESMT Berlin",
    programName: "Master's in Management",
    field: "management",
    country: "Germany",
    city: "Berlin",
    tuitionUSDPerYear: 27000,
    livingCostUSDPerYear: 16000,
    durationYears: 2,
    medianStartingSalaryUSD: 70000,
    employmentRate6Mo: 0.9,
    ...
    typicalAdmittedCGPA: 8.0,
    postStudyWorkVisaYears: 1.5,
    visaApprovalRateIndia: 0.92,
    tierTag: "strong",
    indianCohortNotes:
      "ESMT is Germany's most credible English-taught management program. The 18-month German Job Seeker visa post-graduation is the real prize. Tight industry ties with German Mittelstand and Berlin tech.",
  },
  {
    id: "warwick-mim",
    university: "University of Warwick (WBS)",
    ...
    livingCostUSDPerYear: 18000,
    durationYears: 1,
    medianStartingSalaryUSD: 60000,
    employmentRate6Mo: 0.84,
    baselineAdmitRate: 0.35,
    typicalAdmittedGRE: 0,
    typicalAdmittedCGPA: 7.8,
    postStudyWorkVisaYears: 2,
    visaApprovalRateIndia: 0.87,
    tierTag: "strong",
    indianCohortNotes:
      "More accessible than LBS or HEC — a credible MiM bet for Tier-2 college profiles with strong CGPA. Coventry is cheap to live in. London placement is real but you'll work harder for it than an LBS grad.",
  },
];
